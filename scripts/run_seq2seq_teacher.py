...
def main():
    ...
    def preprocess_squad_batch(
        ...
        def generate_input(_question, _context):
            if not data_args.chat:
                ...
                return " ".join(["history:", _question.lstrip(), "persona:", _context.lstrip()])
    ...
    def post_processing_function(
        ...
        references = [
            {"id": ex["id"], "answers": {"text": [ex[answer_column]], "answer_start": [0]}}
            for ex in examples
        ]
    ...
    if training_args.do_predict:
        ...
        output_data = [
            {"id": prediction["id"], "answer": prediction["prediction_text"]}
